...
% perfil_structure =perfil_structure_V2;
%% Parametros de Chute
...
%Asa
aviao.b = 2.266;                    %[m] Envergadura da asa
aviao.fb = [0.3530450132 0.4077762619 0.9085223016];           %[m] Vetor com frações de envergadura
aviao.AR = 4.56684;                   %[-] Razão de aspecto
aviao.i_w = 0;                  %[º] Incidência na raiz
aviao.t = [0.9 0.9 0.82305 0.73818];         %[-] Vetor de taper em cada seção
aviao.l = [0 5 5 0];         %[] Vetor enflechamento
aviao.tw = [0 0 0 0];        %[°] Vetor de twist
aviao.d = [0 -5 -10 -20];         %[] Vetor de diedro em cada seção
aviao.perfil = [5 5 5 5 5]; %[-] Vetor de perfis em cada seção
aviao.h_BA = 0.15;                 %[m] Altura do BA da asa

%Cauda
aviao.d_BF_BA_x = 0.4;            %[m] Distância do BF da asa ao BA da cauda em x
aviao.d_BF_BA_z = 0.05;            %[m] Distância do BF da asa ao BA da cauda em z
aviao.c_root_EH = 0.2;            %[m] Corda na raiz da EH
aviao.t_EH = [0.8 0.9];            %[-] Vetor de taper em cada seção da EH
aviao.b_EH = 0.25;                 %[m] Envergadura da EH
aviao.fb_EH = 0.8;
aviao.i_EH = 0;                 %[°] Incidência da EH
aviao.f_prof = 0.25;               %[-] Fração de corda atuável da EH
aviao.perfil_EH = 10;            %[-] Perfil da EH

aviao.f_x_cg = 0.2;               %[-] Posição do CG em x/c_root
