function [ geom_malha] = AeroMalhaGeometriaTop( geom, perfil_structure )
...
%     [ perfil_center_final ] = AchaCentroPerfil( pontos_final,x );   % Acha linha média
    [perfil_top_final] = AchaPerfilTop(pontos_final,x);
    %Parasita
...
%     Mi = [Mi_ant,Mi_ant];
    ...
    X1 = X1+[offsetX_Twist,offsetX_Twist];
