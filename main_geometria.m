...
while (y<= ymax) && P<18
    ...
    zlim = thick(i,2)*chord*0.8; %limite de z, é a espessura da origem do comp de carga com folga de 20%
...
% %     zlim = (zsup-zinf)*0.8 %limite de z, é a espessura da origem do comp de carga com folga de 20%
    ...
    while (z<zlim && P<18)
        z = z + dz;
        i = i-1;
        while thick(i,2)*chord*0.81>zlim %i nao reiniciou ainda, parte da origem e vai até o BA
            i = i-1;
        end
